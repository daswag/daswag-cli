...
export class Prompt {
  ...
  public async askForEntityType(configValue: string | undefined): Promise<Generator.Answers> {
    return configValue === undefined ? this.generator.prompt([{
      ...
      message: `Which kind of entity do you want?`,
      name: 'type',
      type: 'list',
    }]) : { type: configValue };
  }
  ...
  public async askForLinkedEntityName(entities: IEntitySchema[] | undefined): Promise<Generator.Answers> {
    ...
    return this.generator.prompt([{
      ...
      message: `Which entity would you link to linked?`,
  ...
  public async askForEntitySchema(): Promise<IEntitySchema> {
    ...
    while(answerAddAttribute && answerAddAttribute.addAttribute) {
      ...
      const answerName = await this.askForAttributeName();
      ...
      if(answerAttributeDataType && answerAttributeDataType.attributeDataType && answerAttributeDataType.attributeDataType === Prompt.ENTITY_ATTRIBUTE_TYPE_NUMBER_VALUE) {
      ...
      } else if(answerAttributeDataType && answerAttributeDataType.attributeDataType && answerAttributeDataType.attributeDataType === Prompt.ENTITY_ATTRIBUTE_TYPE_STRING_VALUE) {
  ...
  public async askForAttributeName(): Promise<Generator.Answers> {
    return this.generator.prompt([{
  ...
  public async askForMinLength(): Promise<Generator.Answers> {
    return this.generator.prompt([{
      message: `What is the min length of your attribute?`,
      name: 'minLength',
      type: 'input',
      validate: (input: string) => {
        if (!/[\d]+/.test(input)) {
  ...
  public async askForMaxLength(): Promise<Generator.Answers> {
    return this.generator.prompt([{
      message: `What is the max length of your attribute?`,
      name: 'maxLength',
      type: 'input',
      validate: (input: string) => {
        if (!/[\d]+/.test(input)) {
  ...
  public async askForMaxValue(): Promise<Generator.Answers> {
    return this.generator.prompt([{
      message: `What is the max value of your attribute?`,
      name: 'maxValue',
      type: 'input',
      validate: (input: string) => {
        if (!/[\d]+/.test(input)) {
  ...
  public async askForMinValue(): Promise<Generator.Answers> {
    return this.generator.prompt([{
      message: `What is the min value of your attribute?`,
      name: 'minValue',
      type: 'input',
      validate: (input: string) => {
        if (!/[\d]+/.test(input)) {
  ...
  public async askForNumberConstraint(): Promise<Generator.Answers> {
    return this.generator.prompt([ {
      default: false,
      message: `Do you want to add a constraint on your Number attribute (minvalue, maxvalue)?`,
      name: 'addConstraint',
      type: 'confirm',
    }]);
  }
  ...
  public async askForStringConstraint(): Promise<Generator.Answers> {
    return this.generator.prompt([ {
      default: false,
      message: `Do you want to add a constraint on your String attribute (minlength, maxlength)?`,
      name: 'addConstraint',
      type: 'confirm',
    }]);
  }
  ...
  public async askForMutable(): Promise<Generator.Answers> {
    return this.generator.prompt([ {
      message: `Do you want to make it mutable?`,
      name: 'mutable',
      type: 'confirm',
    }]);
  }
  ...
  public async askForRequired(): Promise<Generator.Answers> {
    return this.generator.prompt([ {
      message: `Do you want to make it required?`,
      name: 'required',
      type: 'confirm',
    }]);
  }
  ...
  public async askForAddAttribute(): Promise<Generator.Answers> {
    return this.generator.prompt([ {
      message: `Do you want to add an attribute to your entity?`,
      name: 'addAttribute',
      type: 'confirm',
    }]);
  }
